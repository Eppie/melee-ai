...
class Action(Enum):
    ...
    DEAD_UP = 0x3  # Upward death used in 1P "Team Kirby", etc.
    DEAD_FLY_STAR = 0x4  # Standard Star KO
    ...
    DEAD_FALL = 0x23  # Special fall after UpB or airdodge
    SPECIAL_FALL_FORWARD = 0x24  # Special fall with forward DI
    SPECIAL_FALL_BACK = 0x25  # Special fall with backward DI
    TUMBLING = 0x26  # DamageFall
    ...
    EDGE_JUMP_1_SLOW = 0x104  # Ledge jump >= 100% damage
    EDGE_JUMP_2_SLOW = 0x105  # Ledge jump >= 100% damage
    EDGE_JUMP_1_QUICK = 0x106  # Ledge jump < 100% damage
    EDGE_JUMP_2_QUICK = 0x107  # Ledge jump < 100% damage
    TAUNT_RIGHT = 0x108
    TAUNT_LEFT = 0x109
