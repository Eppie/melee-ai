...
# Tech Action IDs
TECH_NEUTRAL = {Action.NEUTRAL_TECH.value, Action.WALL_TECH.value, Action.CEILING_TECH.value}
...
def main():
    ...
    all_events = events_dict["neutral"] + events_dict["forward"] + events_dict["backward"]
    if not all_events:
