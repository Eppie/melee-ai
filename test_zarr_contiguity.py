...
def test_zarr_contiguity():
    ...
    for data_dir_name in ["processed_data_5700", "processed_data_1000", "processed_data_100", "processed_data"]:
    ...
    print(f"{'Position':>8} | {'X C-contig':>11} | {'Y C-contig':>11} | {'X needs copy':>13} | {'Y needs copy':>13}")
    print("-" * 75)
    ...
    for start in test_positions:
        ...
        print(f"{start:>8} | {str(x_contig):>11} | {str(y_contig):>11} | {str(not x_contig):>13} | {str(not y_contig):>13}")
    ...
    if chunk_size_t:
        ...
        print(f"{'Position':>8} | {'Description':>30} | {'X C-contig':>11} | {'Y C-contig':>11}")
        print("-" * 75)
        ...
        for start, desc in boundary_tests:
            ...
            print(f"{start:>8} | {desc:>30} | {str(x_contig):>11} | {str(y_contig):>11}")
